[README.md](https://github.com/user-attachments/files/25391041/README.md)
...
### ภาพรวม
 เป็นเครื่องมือแบบ Command Line (CLI) สำหรับ **เข้ารหัส/ถอดรหัส**
...
### Overview
is a command-line tool to **encrypt/decrypt**
